...
public class OperacionMatematica implements Calculable {
    ...
    /**
     * Metodo de suma, arroja IllegalArgumentException si la operacion no comenz� con el metodo "comenzar()"
     * @param n
     * @return
     */
    ...
    /**
     * * Metodo de resta, arroja IllegalArgumentException si la operacion no comenz� con el metodo "comenzar()"
     * @param n
     * @return
     */
